...
- 현재 상태: ABC마트/29CM 검색 Collector와 RabbitMQ 검색 작업/결과 Worker 구현, Spring Boot Product Backend의 Flyway/JPA 저장, 수집 검색어/filters 연결 및 상품 조회 API 구현, Spring RabbitMQ 연결과 MCP/Web은 planned
