...
public final class CollectionQueueNames {
	...
	public static final String SEARCH_TASK_QUEUE = "purchase-research.collection.search.v1";
	public static final String SEARCH_RETRY_QUEUE = "purchase-research.collection.search.retry.v1";
	public static final String SEARCH_DEAD_LETTER_QUEUE = "purchase-research.collection.search.dlq.v1";
	...
	public static final String SEARCH_ROUTING_KEY = "collection.search";
	public static final String SEARCH_RETRY_ROUTING_KEY = "collection.search.retry";
	public static final String SEARCH_DEAD_LETTER_ROUTING_KEY = "collection.search.dead";
