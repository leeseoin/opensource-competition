...
checkpoint, 요청 예산, 안전 중단과 gzip NDJSON 저장이 구현됐다. 동일 fixture benchmark와
100개/1,000개/최대 10,000개 단계별 실수집을 완료했으며 결과는
[Python/Go 크롤러 확장성과 성능 비교 보고서](../reports/2026-08-04_Python_Go_크롤러_확장성과_성능_비교_보고서.md)에 기록했다.
...
| 지표 | 값 |
|---|---:|
| 목표/실제 고유 상품 | ABC마트 10,000/9,417, 29CM 10,000/10,000 |
| 중복 제거 전 상품 | 보고서의 언어별 최대 단계 표 참조 |
| Contract 성공/실패 | 네 조합 최대 단계 38,834/0 |
| 요청/오류/429 | 오류/429 0, 요청 수는 보고서 참조 |
| wall time/처리량 | 실수집과 fixture benchmark를 분리해 보고서에 기록 |
| CPU/최대 메모리 | 언어/판매처별 보고서에 기록 |
| checkpoint 재개 | ABC마트 양쪽 언어에서 검증 |
