...
9. [Python/Go 크롤러 비교 결과](reports/2026-08-04_Python_Go_크롤러_확장성과_성능_비교_보고서.md): ABC마트/29CM 단계별 실수집과 fixture 성능 결과
10. [Git 브랜치 작업 방식](development/Git_브랜치_작업_방식.md): 개인 실험, 개인별 정리, 협업 통합 및 main 반영 순서를 설명
...
- [2026-08-04 Python/Go 크롤러 확장성과 성능 비교 보고서](reports/2026-08-04_Python_Go_크롤러_확장성과_성능_비교_보고서.md): 공통 Contract, 최대 단계 실수집, parser 성능과 권장 선택
