...
- 2026-08-13 / [`MCP-003` 조건부 수집 freshness 범위 수정](2026-08-13-MCP-003-조건부_수집_freshness_범위_수정.md) / `cc628e0` / 다른 검색어의 최신 상품을 현재 검색 범위로 오인하지 않고 동일 판매처/검색어/필터의 실제 수집 문맥으로 판정
