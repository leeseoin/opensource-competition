...
- 2026-08-11 / [`MCP-003` 상태 기반 구매 조사 Agent Run](2026-08-11-MCP-003-상태_기반_Agent_Run.md) / `721581e`, `400dbf6`, `6872baf`, `6d218e1`, `56c7a23`, `206b168`, `dee92e7` / DB 우선 검색과 조건부 수집 및 선택 상품 재검증을 하나의 복구 가능한 실행 상태로 연결
